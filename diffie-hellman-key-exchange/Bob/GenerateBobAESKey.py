...
if __name__ == "__main__":
    # Read the shared secret (K2) from a file named "K2_PreSecretKey.txt"
    try:
        directory = os.path.dirname(__file__)  # Get the directory of the current file
        filepathPreSecretKey = os.path.join(directory, "K2_PreSecretKey.txt")
